...
import AnimatedGradient from "@/sesame/components/background/animated-gradient-with-svg"
...
const BentoCard: React.FC<BentoCardProps> = ({
  ...
  <div className="relative overflow-hidden rounded-2xl min-h-[120px] sm:min-h-[180px] h-full w-full flex flex-col justify-between p-4 sm:p-6 font-medium">
    ...
    >
      ...
      {description && (
        <div className="text-white text-[10px] sm:text-xs mt-auto mb-1 sm:mb-2 text-pretty leading-tight">
          {description}
        </div>
      )}
      {buttonText && (
