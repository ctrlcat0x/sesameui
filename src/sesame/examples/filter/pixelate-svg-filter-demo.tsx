...
import PixelateSvgFilter from "@/sesame/components/filter/pixelate-svg-filter"
...
export default function PixelateSVGFilterDemo() {
  ...
  return (
    <div
      className="relative flex flex-col items-center justify-center w-full h-full gap-4 bg-black"
      ref={containerRef}
    >
